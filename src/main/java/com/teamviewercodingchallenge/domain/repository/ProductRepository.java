 ...
 * Description: This file defines the repository interface for managing Product entities.
 ...
 * for Product entities in the database.
 * 
 * Dependencies:
 * - Spring Data JPA: Provides JpaRepository interface for working with JPA entities.
 * 
 * Usage:
 * - This interface is used to define methods for accessing and manipulating Product entities in the database.
...
// Declares the ProductRepository interface extending JpaRepository. This enables it to inherit methods for working with Product data in the database.
public interface ProductRepository extends JpaRepository<Product, Long> {
    // By extending JpaRepository, ProductRepository inherits methods to save, delete, and find Product entities, among others.
    // The first type parameter, Product, specifies the entity type the repository manages.
